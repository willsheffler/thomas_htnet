...
struct hbond_candidate{
	hbond_candidate( core::Size moltenres1_in, core::Size rot1_in, core::Size moltenres2_in, core::Size rot2_in, core::Real score_in){
...
struct hbond_net_struct : public utility::pointer::ReferenceCount {
	...
	//SkipList< core::Size > jack_compat_net_indices;                    //network_vector_ indices of other h-bond networks that are compatible with this one
	//SkipList< utility::pointer::shared_ptr< hbond_net_struct const > > jack_compat_net_indices;
...
struct NetworkState{
	NetworkState( core::pack::hbnet::HBondEdge * init_state, core::pack::hbnet::HBondGraphOP hbond_graph ){
		...
		NetworkResidue const first( static_cast< core::pack::hbnet::HBondNode *  > ( hbond_graph->get_node( init_state->get_first_node_ind() ) ) );
		residues.push_back( first );

		NetworkResidue const second( static_cast< core::pack::hbnet::HBondNode *  > ( hbond_graph->get_node( init_state->get_second_node_ind() ) ) );
		residues.push_back( second );

		//residues.push_back( NetworkResidue( static_cast< core::pack::hbnet::HBondNode *  > hbond_graph->get_node( init_state->get_second_node_ind() ) ) );
	}

	utility::vector1< NetworkResidue > residues;
	//utility::vector1< NetworkResidue > residues_that_still_need_to_be_satisfied; //subset of "rotamers"
...
public:
	...
	utility::vector1< utility::vector1< core::conformation::ResidueOP > > network_residues() {
		return network_residues_;
	}

	void jack_store_networks( const bool setting ){ jack_store_networks_ = setting; }
	void set_hb_threshold( const core::Real setting){ hydrogen_bond_threshold_ = setting; }
...
protected:
	...
	//void parse_HBondNetworkTracker( core::pack::hbnet::HBondNetworkTrackerOP tracker, core::Size num_residues );
	...
	void traverse_IG_for_3mers_find_third_rotamer( core::Size resA, core::Size moltenresA, core::Size rotA, core::Size resA_ind, core::Size resB, core::Size moltenresB, core::Size rotB, core::Size resB_ind, core::Real const hb_threshold, core::Real init_sc, utility::vector1< HBondResStructCOP > & residues );

	void greedy_traverse_IG( core::Real const hb_threshold );
	bool greedy_recursive_traverse( core::Real const hb_threshold, Size moltenres, utility::vector1< core::Size > & state_for_moltenres, core::pose::PoseOP & network_pose );
	...
	bool no_clash( core::Size moltenres1, core::Size state1, core::Size moltenres2, core::Size state2 );
	...
	void monte_carlo_branching_trajectory( core::Size seed_index, std::set< unsigned long > & clashes, std::vector< utility::vector1< core::Size > > & overlapping_nets );
	...
	void merge_branched_networks(core::Size merged_vec_index, HBondNetStructOP new_network);
	...
	bool all_residue_chis_are_close( utility::vector1< HBondResStructCOP > & residues1, utility::vector1< HBondResStructCOP > & residues2 );
	...
	virtual
	void consider_network_as_branch_seed( HBondNetStructOP net, core::Size network_vector_index );
...
protected:
	inline
	utility::vector1< core::Size > & branch_seed_network_vector(){
	...
	inline
	core::Size chain_for_moltenres( core::Size mres ){
		return orig_pose_->chain( rotamer_sets_->moltenres_2_resid( mres ) );
	}

	inline
	core::select::residue_selector::ResidueSubset const & core_residues() const{
...
private:
	...
	void print_SAT_model_to_file( std::string filename, bool prefpolar, bool pref2polar );
	void print_ILP_model_to_file( std::string filename );
	void print_CFN_model_to_file( std::string filename, bool prefpolar, bool pref2polar );
...
private:
	...
	//utility::vector1< HBondNetStructOP > branch_seed_network_vector_; //starting points for branching
	utility::vector1< core::Size > branch_seed_network_vector_; //starting points for branching, values are network_vector_ indices
	...
	utility::vector1< utility::vector1< core::conformation::ResidueOP > > network_residues_;
...
public:
	...
	static bool node_is_compatible( NetworkState & current_state, core::pack::hbnet::HBondNode const * node_being_added );

protected:

	inline core::pack::hbnet::HBondEdge * register_hbond( core::Size rotamerA, core::Size rotamerB, core::Real score );
	inline void register_clash( core::Size rotamerA, core::Size rotamerB );
	//core::Real twobody_energy( core::pack::hbnet::HBondNode *, core::pack::hbnet::HBondNode * ) const;
	static core::Real twobody_energy( core::pack::interaction_graph::NodeBase const & ig_node, core::Size first_node_state, core::pack::hbnet::HBondNode * hbond_node );

	virtual inline bool edge_can_yield_initialization_state(core::pack::interaction_graph::EdgeBase*){
		return true;
	}

	core::pack::hbnet::HBondNode * get_next_node( NetworkState & current_state, core::Real temperature, std::set< core::Size > & node_ids_to_never_consider );
	core::pack::hbnet::HBondNode * get_next_node_weighted_by_path_potential( NetworkState & current_state, std::set< core::Size > & node_ids_to_never_consider ) const;

	bool initialization_state_is_dead_end( core::pack::hbnet::HBondEdge * init_state );

	bool addition_results_in_unsatisfiable_dead_end( NetworkState & current_state, core::pack::hbnet::HBondNode * node_being_added );
